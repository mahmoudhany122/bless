      ...
      appBar: AppBar(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text("مرحبآ",style: TextStyle(fontSize: 18,color: Colors.black),),
                        SizedBox(width: 5,),
                        Image(
                          height: 20,
                          width: 20,
                    ...
                    Text("د. عادل عيسى",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black),)
                  ],
                ),
       ...
       TabBar(
        ...
        tabs: [
          ...
          Tab(
            child:
            Text ("الصفحة الرئيسية",style: TextStyle(fontSize:20,fontWeight: FontWeight.bold, ),) ,
          ) ,
        ],
      ),
        Expanded(child:
