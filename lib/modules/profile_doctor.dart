                                          ...
                                          child: TextButton(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(width: 5,),
                                                Text("تعديل الملف الشخصي".tr,style:
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                DropdownButton(
                                                  items: [
                                                    DropdownMenuItem(
                                                        child: Text("اللغه الانجليزيه".tr,style: TextStyle(color:HexColor('00B4D8'), ),),
                                                        value : 'en'),
                                                    DropdownMenuItem(
                                                        child: Text("اللغه العربيه".tr,style: TextStyle(color:HexColor('00B4D8'), ),),
                                                        value : 'ar'),
                                                  ],
                        ...
                        builder: (context)=>AlertDialog(
                            actions: [
                              ...
                              Container(
                                  ...
                                  height : 40,
                                  decoration: BoxDecoration(
                                      border: Border.all(color:HexColor('00B4D8')),
                                  ...
                                  TextButton (
                                    onPressed: (){  Navigator.pushAndRemoveUntil(
                                        context,MaterialPageRoute(builder: (context) => TabBarScreen(), ),(route) => false);},
                                    child: Text(
                            ...
                            , title:
                        Center(
                          child: Text ("تسجيل خروج".tr,style: TextStyle(color: HexColor('00B4D8'),fontWeight: FontWeight.bold ,fontSize: 28),
